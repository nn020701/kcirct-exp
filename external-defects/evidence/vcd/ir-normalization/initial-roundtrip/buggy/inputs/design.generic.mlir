#loc = loc(".work/ir-preparation/initial-register-v1/s2/buggy/design.mlir":5:105)
#loc1 = loc(".work/ir-preparation/initial-register-v1/s2/buggy/design.mlir":5:129)
#loc2 = loc(".work/ir-preparation/initial-register-v1/s2/buggy/design.mlir":5:153)
#loc3 = loc(".work/ir-preparation/initial-register-v1/s2/buggy/design.mlir":5:176)
"builtin.module"() ({
  ...
  ^bb0(%arg0: i1, %arg1: i1, %arg2: i1):
    ...
    %43 = "comb.concat"(%7, %69) : (i28, i4) -> i32
    %44 = "comb.icmp"(%43, %9) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %45 = "comb.and"(%42, %44) : (i1, i1) -> i1
    %46 = "comb.icmp"(%69, %3) <{predicate = 0 : i64}> : (i4, i4) -> i1
    %47 = "comb.and"(%arg1, %45) : (i1, i1) -> i1
    %48 = "comb.and"(%arg1, %46) : (i1, i1) -> i1
    %49 = "seq.firreg"(%47, %35) <{name = "axis_tvalid_delay"}> : (i1, !seq.clock) -> i1
    %50 = "seq.firreg"(%48, %35) <{name = "axis_tlast_delay"}> : (i1, !seq.clock) -> i1
    %51 = "comb.icmp"(%69, %1) <{predicate = 0 : i64}> : (i4, i4) -> i1
    %52 = "comb.add"(%69, %2) : (i4, i4) -> i4
    %53 = "comb.mux"(%15, %8, %69) : (i1, i4, i4) -> i4
    %54 = "comb.and"(%44, %arg1) : (i1, i1) -> i1
    %55 = "comb.and"(%72, %54) : (i1, i1) -> i1
    %56 = "comb.mux"(%55, %52, %53) : (i1, i4, i4) -> i4
    %57 = "comb.or"(%55, %15) : (i1, i1) -> i1
    %58 = "comb.xor"(%55, %0) : (i1, i1) -> i1
    %59 = "comb.or"(%55, %15, %51) : (i1, i1, i1) -> i1
    %60 = "comb.xor"(%72, %0) : (i1, i1) -> i1
    %61 = "comb.and"(%54, %60) : (i1, i1) -> i1
    %62 = "comb.xor"(%61, %0) : (i1, i1) -> i1
    %63 = "comb.and"(%62, %57) : (i1, i1) -> i1
    %64 = "comb.and"(%62, %58, %arg1, %51) : (i1, i1, i1, i1) -> i1
    %65 = "comb.and"(%62, %59) : (i1, i1) -> i1
    %66 = "comb.xor"(%63, %0) : (i1, i1) -> i1
    %67 = "comb.or"(%66, %61) : (i1, i1) -> i1
    %68 = "comb.mux"(%67, %69, %56) <{twoState}> : (i1, i4, i4) -> i4
    %69 = "seq.firreg"(%68, %35) <{name = "read_pointer", preset = 0 : i4}> : (i4, !seq.clock) -> i4
    %70 = "comb.mux"(%65, %64, %71) <{twoState}> : (i1, i1, i1) -> i1
    %71 = "seq.firreg"(%70, %35) <{name = "tx_done"}> : (i1, !seq.clock) -> i1
    %72 = "comb.and"(%arg2, %45) : (i1, i1) -> i1
    %73 = "comb.add"(%43, %11) : (i32, i32) -> i32
    %74 = "comb.and"(%72, %arg1) : (i1, i1) -> i1
    %75 = "comb.mux"(%74, %73, %11) : (i1, i32, i32) -> i32
    %76 = "comb.and"(%arg1, %60) : (i1, i1) -> i1
    %77 = "comb.mux"(%76, %78, %75) <{twoState}> : (i1, i32, i32) -> i32
    %78 = "seq.firreg"(%77, %35) <{name = "stream_data_out"}> : (i32, !seq.clock) -> i32
    "hw.output"(%49, %78, %6, %50) : (i1, i32, i4, i1) -> ()
  }) : () -> ()
}) : () -> ()
