...
if OUT.exists(): raise SystemExit('拒绝覆盖既存审计证据')
errors=[]
...
check(collections.Counter(x['status'] for x in results)=={'pass':10},'目标批次VCD结果应为10通过')
