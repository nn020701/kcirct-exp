...
int main(int argc, char **argv) {
  ...
  output << "s_axis_tready,m_axis_tdata,m_axis_tvalid,m_axis_tlast,m_axis_tuser,status_overflow,status_bad_frame,status_good_frame\n";

  for (size_t sample = 0; sample < 185; ++sample) {
    dut.clk = 0;
    uint64_t value = 0;
