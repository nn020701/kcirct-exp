#loc = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:197)
#loc1 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:322)
#loc2 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:345)
#loc3 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:367)
#loc4 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:531)
#loc5 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:555)
#loc6 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:578)
#loc7 = loc("/Users/bytedance/cym/cymProject/k-circt-top-repo/services/circt-semantics/benchmarks/external-defects/results/batch-final-01/s1r/buggy/kimulator/design.mlir":15:600)
"builtin.module"() ({
  ...
  ^bb0(%arg0: i1, %arg1: i1, %arg2: i7, %arg3: i3, %arg4: i1, %arg5: i32, %arg6: i4, %arg7: i1, %arg8: i1, %arg9: i7, %arg10: i3, %arg11: i1, %arg12: i1):
    ...
    %1516 = "comb.xor"(%1521, %5) : (i1, i1) -> i1
    %1517 = "comb.and"(%1516, %arg11) : (i1, i1) -> i1
    %1518 = "comb.and"(%arg1, %1517) : (i1, i1) -> i1
    %1519 = "comb.mux"(%1518, %arg9, %39) : (i1, i7, i7) -> i7
    %1520 = "comb.or"(%46, %1517) : (i1, i1) -> i1
    %1521 = "seq.firreg"(%1518, %44) <{name = "axi_arready"}> : (i1, !seq.clock) -> i1
    %1522 = "comb.mux"(%1520, %1519, %1523) <{twoState}> : (i1, i7, i7) -> i7
    %1523 = "seq.firreg"(%1522, %44) <{name = "axi_araddr"}> : (i7, !seq.clock) -> i7
    %1524 = "comb.xor"(%1533, %5) : (i1, i1) -> i1
    %1525 = "comb.and"(%1533, %arg12) : (i1, i1) -> i1
    %1526 = "comb.xor"(%1525, %5) : (i1, i1) -> i1
    %1527 = "comb.and"(%1526, %1533) : (i1, i1) -> i1
    %1528 = "comb.and"(%arg1, %1521, %arg11, %1524) : (i1, i1, i1, i1) -> i1
    %1529 = "comb.or"(%1528, %1527) : (i1, i1) -> i1
    %1530 = "comb.and"(%arg1, %1529) : (i1, i1) -> i1
    %1531 = "comb.or"(%46, %1528, %1525) : (i1, i1, i1) -> i1
    %1532 = "comb.mux"(%1531, %1530, %1533) <{twoState}> : (i1, i1, i1) -> i1
    %1533 = "seq.firreg"(%1532, %44) <{name = "axi_rvalid"}> : (i1, !seq.clock) -> i1
    %1534 = "comb.and"(%1521, %arg11, %1524) : (i1, i1, i1) -> i1
    %1535 = "comb.extract"(%1523) <{lowBit = 2 : i32}> : (i7) -> i5
    ...
    %1567 = "comb.mux"(%1566, %1502, %1506) : (i1, i32, i32) -> i32
    ...
    %1625 = "comb.mux"(%1624, %1498, %1567) : (i1, i32, i32) -> i32
    %1626 = "comb.and"(%1622, %1564) : (i1, i1) -> i1
    %1627 = "comb.mux"(%1626, %1494, %1625) : (i1, i32, i32) -> i32
    %1628 = "comb.and"(%1620, %1563) : (i1, i1) -> i1
    %1629 = "comb.mux"(%1628, %1490, %1627) : (i1, i32, i32) -> i32
    %1630 = "comb.and"(%1618, %1562) : (i1, i1) -> i1
    %1631 = "comb.mux"(%1630, %1486, %1629) : (i1, i32, i32) -> i32
    %1632 = "comb.and"(%1616, %1561) : (i1, i1) -> i1
    %1633 = "comb.mux"(%1632, %1482, %1631) : (i1, i32, i32) -> i32
    %1634 = "comb.and"(%1614, %1560) : (i1, i1) -> i1
    %1635 = "comb.mux"(%1634, %1478, %1633) : (i1, i32, i32) -> i32
    %1636 = "comb.and"(%1612, %1559) : (i1, i1) -> i1
    %1637 = "comb.mux"(%1636, %1474, %1635) : (i1, i32, i32) -> i32
    %1638 = "comb.and"(%1610, %1558) : (i1, i1) -> i1
    %1639 = "comb.mux"(%1638, %1470, %1637) : (i1, i32, i32) -> i32
    %1640 = "comb.and"(%1608, %1557) : (i1, i1) -> i1
    %1641 = "comb.mux"(%1640, %1466, %1639) : (i1, i32, i32) -> i32
    %1642 = "comb.and"(%1606, %1556) : (i1, i1) -> i1
    %1643 = "comb.mux"(%1642, %1462, %1641) : (i1, i32, i32) -> i32
    %1644 = "comb.and"(%1604, %1555) : (i1, i1) -> i1
    %1645 = "comb.mux"(%1644, %1458, %1643) : (i1, i32, i32) -> i32
    %1646 = "comb.and"(%1602, %1554) : (i1, i1) -> i1
    %1647 = "comb.mux"(%1646, %1454, %1645) : (i1, i32, i32) -> i32
    %1648 = "comb.and"(%1600, %1553) : (i1, i1) -> i1
    %1649 = "comb.mux"(%1648, %1450, %1647) : (i1, i32, i32) -> i32
    %1650 = "comb.and"(%1598, %1552) : (i1, i1) -> i1
    %1651 = "comb.mux"(%1650, %1446, %1649) : (i1, i32, i32) -> i32
    %1652 = "comb.and"(%1596, %1551) : (i1, i1) -> i1
    %1653 = "comb.mux"(%1652, %1442, %1651) : (i1, i32, i32) -> i32
    %1654 = "comb.and"(%1594, %1550) : (i1, i1) -> i1
    %1655 = "comb.mux"(%1654, %1438, %1653) : (i1, i32, i32) -> i32
    %1656 = "comb.and"(%1592, %1549) : (i1, i1) -> i1
    %1657 = "comb.mux"(%1656, %1434, %1655) : (i1, i32, i32) -> i32
    %1658 = "comb.and"(%1590, %1548) : (i1, i1) -> i1
    %1659 = "comb.mux"(%1658, %1430, %1657) : (i1, i32, i32) -> i32
    %1660 = "comb.and"(%1588, %1547) : (i1, i1) -> i1
    %1661 = "comb.mux"(%1660, %1426, %1659) : (i1, i32, i32) -> i32
    %1662 = "comb.and"(%1586, %1546) : (i1, i1) -> i1
    %1663 = "comb.mux"(%1662, %1422, %1661) : (i1, i32, i32) -> i32
    %1664 = "comb.and"(%1584, %1545) : (i1, i1) -> i1
    %1665 = "comb.mux"(%1664, %1418, %1663) : (i1, i32, i32) -> i32
    %1666 = "comb.and"(%1582, %1544) : (i1, i1) -> i1
    %1667 = "comb.mux"(%1666, %1414, %1665) : (i1, i32, i32) -> i32
    %1668 = "comb.and"(%1580, %1543) : (i1, i1) -> i1
    %1669 = "comb.mux"(%1668, %1410, %1667) : (i1, i32, i32) -> i32
    %1670 = "comb.and"(%1578, %1542) : (i1, i1) -> i1
    %1671 = "comb.mux"(%1670, %1406, %1669) : (i1, i32, i32) -> i32
    %1672 = "comb.and"(%1576, %1541) : (i1, i1) -> i1
    %1673 = "comb.mux"(%1672, %1402, %1671) : (i1, i32, i32) -> i32
    %1674 = "comb.and"(%1574, %1540) : (i1, i1) -> i1
    %1675 = "comb.mux"(%1674, %1398, %1673) : (i1, i32, i32) -> i32
    %1676 = "comb.and"(%1572, %1539) : (i1, i1) -> i1
    %1677 = "comb.mux"(%1676, %1394, %1675) : (i1, i32, i32) -> i32
    %1678 = "comb.and"(%1570, %1538) : (i1, i1) -> i1
    %1679 = "comb.mux"(%1678, %1390, %1677) : (i1, i32, i32) -> i32
    %1680 = "comb.and"(%1568, %1537) : (i1, i1) -> i1
    %1681 = "comb.mux"(%1680, %1386, %1679) : (i1, i32, i32) -> i32
    %1682 = "comb.mux"(%1536, %1382, %1681) : (i1, i32, i32) -> i32
    %1683 = "comb.and"(%arg1, %1534) : (i1, i1) -> i1
    %1684 = "comb.mux"(%1683, %1682, %38) : (i1, i32, i32) -> i32
    %1685 = "comb.or"(%46, %1534) : (i1, i1) -> i1
    %1686 = "comb.mux"(%1685, %1684, %1687) <{twoState}> : (i1, i32, i32) -> i32
    %1687 = "seq.firreg"(%1686, %44) <{name = "axi_rdata"}> : (i32, !seq.clock) -> i32
    "hw.output"(%45, %55, %6, %1515, %1521, %1687, %6, %1533) : (i1, i1, i2, i1, i1, i32, i2, i1) -> ()
  }) : () -> ()
}) : () -> ()
